...
export default function FlightPanel({
  ...
  return (
    <div className="flex justify-center h-full bg-gradient-to-r from-blue-900 to-blue-950 p-10 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2)] backdrop-blur-md rounded-tr-[10px] rounded-br-[10px] w-auto">
        ...
        <div className=" flex text-center flex-col justify-center">
          ...
          >
            ...
            <div className="flex flex-col px-2 min-w-auto relative">
              <div className="text-[25px] text-sky-300 mb-1 uppercase tracking-wider font-medium">
                Flight
              </div>
              <div className="text-1xl md:text-3xl font-semibold whitespace-nowrap overflow-hidden text-ellipsis text-white">
                {currentFlight.flight_number}
              </div>
            </div>
            <div className="w-[2px] h-18 bg-gradient-to-b from-white/10 via-white/30 to-white/10"></div>
            ...
            <div className="flex flex-col px-2 min-w-auto relative">
              ...
              <div className="text-2xl md:text-3xl font-semibold whitespace-nowrap overflow-hidden text-ellipsis text-white">
